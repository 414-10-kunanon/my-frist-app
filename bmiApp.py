...
st.markdown("# :red[🏋️ คำนวณหาค่าดัชนีมวลกาย BMI]")
...
if bmi < 18.5:
  ...
  st.success("❤️คุณน้ำหนักอยู่ในเกณฑ์ปกติ (สุขภาพดี)")
elif 23.0 <= bmi < 25.0:
...
st.divider()
st.write("นายคุณานนต์ ต๊ะต๋า เลขที่ 10 ม.4/14")
